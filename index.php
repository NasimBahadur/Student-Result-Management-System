...
//sql to create table
//$sql = "CREATE TABLE marks(studentId varchar(13),courseId varchar(10),attendance float,assignment float,project float,lab float,quiz float,mid1 float,mid2 float,final float)";
...
//$sql = "CREATE TABLE gradesheet(studentId varchar(13),semester int,courseId varchar(10),credit float,grade varchar(2))";
//if (mysqli_query($conn, $sql)) {
//    echo "Table created successfully";
//}
//else {
...
//       VALUES ('2018-1-60-066', '2', 'CSE251', '4', 'A-')";
//if (mysqli_query($conn, $sql)) {
//    echo "<script>alert('Successfully Submitted.');</script>";
//}
//else {
...
//$sql = "CREATE TABLE gradepoint(studentId varchar(13),semester int,cgpa float,gpa float)";
//if (mysqli_query($conn, $sql)) {
//    echo "Table created successfully";
//}
//else {
...
//       VALUES ('2018-1-60-066', '2', '3.61', '3.59')";
//if (mysqli_query($conn, $sql)) {
//    echo "<script>alert('Successfully Submitted.');</script>";
//}
//else {
...
<div class="container">
    <nav class="navbar navbar-expand-lg navbar-light bg-white border ">
        <a class="nav-link h5 text-dark">Hi ! <?php echo $_SESSION['firstName']." ".$_SESSION['lastName']?></a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="nav nav-fill">
                <li class="nav-item mx-2">
                    <a class="nav-link h6 text-primary" href="#personinfo">Personal Info</a>
                </li>
                <li class="nav-item mx-2">
                    <a class="nav-link h6 text-primary" href="#marks">Exam Marks</a>
                </li>
                <li class="nav-item mx-2">
                    <a class="nav-link h6 text-primary" href="#grade">Grade Report</a>
                </li>
                <li class="nav-item mx-2">
                    <a class="nav-link h6 text-danger" href="logout.php">Log out</a>
                </li>
            </ul>
        </div>
    </nav>
